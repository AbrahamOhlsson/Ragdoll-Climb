...
Shader "standarddoublesidedColourTrans"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
		#pragma target 3.0
		#pragma surface surf StandardSpecular keepalpha addshadow fullforwardshadows alpha
		struct Input
		{
			float2 uv_texcoord;
		};
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			o.Albedo = tex2D( _color, uv_color ).rgb * _Color;
